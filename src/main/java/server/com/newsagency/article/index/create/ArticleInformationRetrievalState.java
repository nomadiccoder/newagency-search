 ...
 *
 */
public class ArticleInformationRetrievalState implements WorkflowState<ArticleIndexCreationContext, ArticleIndexCreationRequest>{
	...
	public void execute(ArticleIndexCreationContext ctxt, ArticleIndexCreationRequest request)
		...
		logger.info("Executing "+getClass().getName());
